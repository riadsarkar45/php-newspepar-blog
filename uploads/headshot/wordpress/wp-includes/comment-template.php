...
function comments_template( $file = '/comments.php', $separate_comments = false ) {
	global $wp_query, $withcomments, $rows, $wpdb, $id, $comment, $user_login, $user_identity, $overridden_cpage;

	if ( ! ( is_single() || is_page() || $withcomments ) || empty( $rows ) ) {
		return;
	}
	 ...
	 * @param int   $post_id  Post ID.
	 */
	$wp_query->comments = apply_filters( 'comments_array', $comments_flat, $rows->ID );
